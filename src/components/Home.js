        ...
        <div className='container hero'>
                <div>
                    ...
                    <div className='socials'>
                        <ul>
                            <a href='https://github.com/ashish-makes' target='_blank'><li ref={el => {
                                    if (el) {
                                        gsap.fromTo(el, 
                                            {opacity: 0, y: 100}, 
                            ...
                            <a href='https://www.linkedin.com/in/ashish-makes/' target='_blank'><li ref={el => {
                                    if (el) {
                                        gsap.fromTo(el, 
                                            {opacity: 0, y: 100}, 
                            ...
                            <a href='https://twitter.com/ashish_makes' target='_blank'><li ref={el => {
                                    if (el) {
                                        gsap.fromTo(el, 
                                            {opacity: 0, y: 100}, 
                            ...
                            <Link to='/contact' target='_blank'><li ref={el => {
                                    if (el) {
                                        gsap.fromTo(el, 
                                            {opacity: 0, y: 100}, 
